	...
	{#if currentState !== 'pending'}
		...
		<div class="flex flex-col gap-2">
			<button
				...
				class="rounded-full bg-linear-to-b from-blue-500 to-sky-500 py-4 text-[1.05rem] text-white shadow-[inset_0.5px_0.5px_0_rgba(255,255,255,0.4),inset_-0.5px_-0.5px_0_rgba(255,255,255,0.2)] transition-transform active:scale-[0.97]"
			>
